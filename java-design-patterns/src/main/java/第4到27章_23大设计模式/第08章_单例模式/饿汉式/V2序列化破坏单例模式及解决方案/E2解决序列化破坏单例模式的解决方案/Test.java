 ...
 ***********************************************************/
package 第4到27章_23大设计模式.第08章_单例模式.饿汉式.V2序列化破坏单例模式及解决方案.E2解决序列化破坏单例模式的解决方案;
...
/**
 * 从下面可以看到反序列化从文件中读取地是一个对象了
 * <p>
 * 第4到27章_23大设计模式.第08章_单例模式.饿汉式.V2序列化破坏单例模式及解决方案.E2解决序列化破坏单例模式的问题.E1序列化破坏单例模式.SingletonHungry@45ee12a7
 * 第4到27章_23大设计模式.第08章_单例模式.饿汉式.V2序列化破坏单例模式及解决方案.E2解决序列化破坏单例模式的问题.E1序列化破坏单例模式.SingletonHungry@45ee12a7
 * true
 */
